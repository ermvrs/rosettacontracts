// These tests wont be compiled. Remove after new tests written
...
mod account_tests {
    ...
    fn test_signature_validation() {
        // EIP2930 tx hash
        let eth_address: EthAddress = 0xE4306a06B19Fdc04FDf98cF3c00472f29254c0e1
            .try_into()
            .unwrap();
        let unsigned_tx_hash: u256 =
            0x105d7b8d7c9fe830c123f2d99c01e09bfa7d902cb3b5afee409cf3dca533f52b;
    ...
    fn test_signature_validation_eip1559() {
        ...
        let eth_address: EthAddress = 0xE4306a06B19Fdc04FDf98cF3c00472f29254c0e1
            ...
            .unwrap();
        let unsigned_tx_hash: u256 =
            0xfea45e666ba85f417463f9c7bd9c0ab532c3a9bf29bb09c73fed760364f6c405;
        let signature = array![
    ...
    fn test_signature_validation_legacy() {
        ...
        let eth_address: EthAddress = 0xE4306a06B19Fdc04FDf98cF3c00472f29254c0e1
            ...
            .unwrap();
        let unsigned_tx_hash: u256 =
            0x04af5100efeb883338fbc81c2c167f0907889760af4002d45b378ee093a882ac;
        let signature = array![
    ...
    fn test_signature_wrong_address() {
        let eth_address: EthAddress = 0xE4306a06B19Fdc04FDf98cF3c00472f29254c0e2
            .try_into()
            .unwrap();
        let unsigned_tx_hash: u256 =
            0x105d7b8d7c9fe830c123f2d99c01e09bfa7d902cb3b5afee409cf3dca533f52b;
    ...
    fn test_transaction_validation_unsupported_tx_type() {
        ...
        let eth_address: EthAddress = 0x30ffDf2c33b929F749afE49D7aBf3f4B8D399B40
            .try_into()
            .unwrap();
    ...
    fn test_legacy_transaction_validation_value_transfer_only() {
        ...
        let unsigned_tx_hash: u256 =
            0x147b5df4a6e91fdbd967747f7b375f155e26225cec38d1e0310e925b2b7565e9;
    ...
    fn test_validate_multicall_transaction() {
        ...
        let unsigned_tx_hash: u256 =
            0x66c3880f27b684f53da1f020f6995153435154c89a11e6c641fa5d137c9edfe8;
        let generated_tx_hash: u256 = generate_tx_hash(tx);
        assert_eq!(generated_tx_hash, unsigned_tx_hash);
    ...
    fn test_execute_multicall_transaction() {
        ...
        let tx = RosettanetCall {
            ...
            calldata: array![
                ...
                strk_address.low,
                strk_address.high,
                transfer_entrypoint.low,
                transfer_entrypoint.high,
                0x3,
                0x0,
                strk_receiver_1.low,
                strk_receiver_1.high,
        ...
        let unsigned_tx_hash: u256 =
            0x0f979b268363cd98b085532a6b1163d73bccb5b1acf58ad0a05d9537c81b297d;
        let generated_tx_hash: u256 = generate_tx_hash(tx);
        assert_eq!(generated_tx_hash, unsigned_tx_hash);
    ...
    fn test_multicall_validate_actual_values() {
        ...
        let unsigned_tx_hash: u256 =
            0x1f766a70ecbf4270faeff147ff3df9fee659426af425bab130f449e47be438eb;
        let generated_tx_hash: u256 = generate_tx_hash(tx);
        assert_eq!(generated_tx_hash, unsigned_tx_hash);
    ...
    fn test_multicall_validate_actual_values_swap() {
        ...
        let unsigned_tx_hash: u256 =
            0x818bd006d9cc1dd0103fce48f6c554f2c23549799eacdced117d87ad54bd7f0d;
        let generated_tx_hash: u256 = generate_tx_hash(tx);
        assert_eq!(generated_tx_hash, unsigned_tx_hash);
