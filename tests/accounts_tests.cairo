...
mod account_tests {
    ...
    fn test_legacy_transaction_validation_calldata() {
        ...
        let tx = RosettanetCall {
            ...
            gas_limit: 21000,
            value: 0,
            calldata: array![0xa9059cbb, 0x042fa70d85ee84eab646a3b438a285ee, 0x000000000000000000000000b756b1bc, 0x000000000000000000000000000f4240, 0x00000000000000000000000000000000]
                .span(),
        };
    ...
    fn test_transaction_validation_calldata_wrong_target_function() {
        ...
        let tx = RosettanetCall {
            ...
            gas_limit: 45439,
            value: 0,
            calldata: array![0xb9059cbc, 0x042fa70d85ee84eab646a3b438a285ee, 0x000000000000000000000000b756b1bc, 0x000000000000000000000000000f4240, 0x00000000000000000000000000000000]
                .span(),
        };
    ...
    fn test_execute_multicall_transaction() {
        ...
        let tx = RosettanetCall {
            ...
            calldata: array![
                0x76971d7f,
                0x2, 0x0,
                strk_address.low, strk_address.high,
                transfer_entrypoint.low, transfer_entrypoint.high,
                0x3, 0x0,
                strk_receiver_1.low, strk_receiver_1.high,
