...
use rosettacontracts::accounts::utils::{RosettanetCall, generate_tx_hash, generate_tx_hash_for_internal_transaction};
...
fn test_validate_multicall_transaction() {
    ...
    let tx = RosettanetCall {
        ...
        gas_limit: 21000,
        value: 0,
        calldata: array![0x76971d7f, 0x2, 0x123123, 0x456456, 0x2, 0x111, 0x222, 0x888888, 0x999999, 0x2, 0x654, 0x321].span(),
        access_list: array![].span(),
        directives: array![0x2,0x1,0x0].span(),
        target_function: array![].span() 
    };
    let signature = array![0x42507df1d32b89c5c789fa3d5d70f9c9,0xf30f73b6dfecb122e9c33e94d8d9c2ec, 0x7ed1b0a8c87e84909580b659562d251f,0x711d7b42f0c91ee717f4770dff7c7f00, 0x1b, 0x0,0x0];
    let (rosettanet, account, _) = deploy_funded_account_from_rosettanet(eth_address);
...
fn test_validate_multicall_transaction_wrong_signature() {
    ...
    let signature = array![0x42607df1d32b89c5c789fa3d5d70f9c9,0xf30f73b6dfecb122e9c33e94d8d9c2ec, 0x7ed1b0a8c87e84909580b659562d251f,0x711d7b42f0c91ee717f4770dff7c7f00, 0x1b, 0x0,0x0];
    let (rosettanet, account, _) = deploy_funded_account_from_rosettanet(eth_address);
...
fn test_execute_multicall_transaction() {
    ...
    let transfer_entrypoint: felt252 = 0x83afd3f4caedc6eebf44246fe54e38c95e3179a5ec9ea81740eca5b482d12e;
    // We dont use eth addresses on multicall
    let (rosettanet, account, strk) = deploy_funded_account_from_rosettanet(eth_address);
    assert_eq!(strk.contract_address.into(), 0xA551825F2E7D5313EE03B1DFE40E2A7B78B27A7FED40FA17AEC27E010BFA96);
    ...
    let tx = RosettanetCall {
        ...
        strk_address, transfer_entrypoint, 
        0x3, strk_receiver_1, strk_1_amount.low.into(), strk_1_amount.high.into(),
        strk_address, transfer_entrypoint,
        0x3, strk_receiver_2, strk_2_amount.low.into(), strk_2_amount.high.into()].span(),
        access_list: array![].span(),
        directives: array![].span(),
        target_function: array![].span() 
    };

    let signature = array![0x56df07af96d2ec1992ab5c5ba1577260,0xdf6e5f3347e5f26e03eecb3c6fa6569b, 0x830eb63af9949d06ef4e6c096f5806,0x680c7672f0b3a18c902a68350cf19b60, 0x1b, 0x0,0x0];
